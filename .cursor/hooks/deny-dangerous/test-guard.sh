...
# Usage: hooks/deny-dangerous/test-guard.sh
...
check block 'git push origin +main'
check block 'gh repo delete sazlin/loadout --yes'
...
check block 'gh api -X DELETE /repos/sazlin/loadout'
check block 'gh api repos/sazlin/loadout --method DELETE'
check block 'gh api --method=delete /repos/x/y'
check block 'gh repo edit sazlin/loadout --visibility public'
...
check allow 'rm -rf ~/Repos/loadout/old-project'
check allow 'rm -rf ~/Repos/loadout/tmp'
...
check allow 'gh repo view sazlin/loadout'
check allow 'gh repo clone sazlin/loadout'
check allow 'gh api /repos/sazlin/loadout'
...
check allow 'gh repo edit sazlin/loadout --description "new desc"'
